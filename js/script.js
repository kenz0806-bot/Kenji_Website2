...
const NEWS_ITEMS = [
    {
        date: '2026.06.12',
        title: 'ウェブサイトをリニューアルし、ブランドムービーを公開しました。',
        summary: '事務所の理念「Keep it Simple」を表現したブランドムービーをトップページに掲載しました。'
    },
    {
        date: '2026.04.01',
        title: '税理士登録のお知らせ',
        summary: '近畿税理士会に税理士登録を行いました。会計・監査に加え、税務面でもご支援が可能になりました。'
    },
    {
        date: '2026.01.04',
        title: 'ウェブサイトを公開しました。',
...
function setupContactDrafts() {
    ...
    // 【追加】初期表示のレイアウトズレ防止：cfoで初期化
    if (templates.cfo) {
        subjectEl.textContent = templates.cfo.subject;
        bodyEl.innerHTML = templates.cfo.body.replace(/\n/g, '<br>');
    }
